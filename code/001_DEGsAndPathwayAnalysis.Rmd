...
hallmark_gsigs <- as.list(qusage::read.gmt('../data/msigdb_v6.2_GMTs/h.all.v6.2.symbols.gmt'))
kegg_gsigs <- as.list(qusage::read.gmt('../data/msigdb_v6.2_GMTs/c2.cp.kegg.v6.2.symbols.gmt'))
biocarta_gsigs <- as.list(qusage::read.gmt('../data/msigdb_v6.2_GMTs/c2.cp.biocarta.v6.2.symbols.gmt'))
reactome_gsigs <- as.list(qusage::read.gmt('../data/msigdb_v6.2_GMTs/c2.cp.reactome.v6.2.symbols.gmt'))
```
